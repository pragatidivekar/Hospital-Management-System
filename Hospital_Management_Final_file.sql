...
INSERT INTO PatientRegister_T(patient_RegisterID,patientID,
    ...
    ('P2','2','2022-06-23','2022-06-30','Doc_1','W1', 'W1S1','Meal2'),
    ('P3','3','2022-08-15','2022-08-15','Doc_5','W1', 'W1S2','Meal5'),
    ('P4','4','2020-07-10','2020-07-11','Doc_3','W1','W1S3','Meal5'),
    ('P5','5','2018-02-23','2018-02-28','Doc_4','W1','W1S4','Meal9'),
    ('P6','6','2017-05-11','2017-05-11','Doc_1','W1','W1S5','Meal8'),
    ('P7','7','2015-03-21','2015-03-22','Doc_2','W2','W2G1','Meal1'),
    ('P8','8','2017-11-05','2017-11-15','Doc_4','W2', 'W2G2','Meal3'),
    ('P9','9','2020-10-10','2020-10-24','Doc_4' , 'W2','W2G3','Meal4'),
    ('P10','10','2022-11-19','2022-11-13','Doc_1' , 'W2','W2G4','Meal4'),
    ('P11','11','2021-07-12','2021-08-12','Doc_2' ,'W2', 'W2G5','Meal4'),
    ('P12','12','2022-11-23','2022-11-24','Doc_3', 'W3','W3S1','Meal8'),
    ('P13','13','2021-09-23','2021-09-29','Doc_12', 'W3','W3S2','Meal10'),
    ('P14','14','2000-11-30','2000-12-30','Doc_19', 'W3','W3S3','Meal7'),
    ('P15','15','2022-10-08','2022-10-09','Doc_18', 'W3','W3S4','Meal6'),
    ('P16','16','2018-09-21','2019-01-21','Doc_21', 'W3','W3S5','Meal6'), 
    ('P17','17','2021-11-24','2021-11-28','Doc_18', 'W4','W4G1','Meal5'), 
    ('P18','18','2022-09-23','2022-10-23','Doc_3', 'W4','W4G2','Meal5'),
    ('P19','19','2021-04-20','2021-04-21','Doc_16','W4', 'W4G3','Meal9'),
    ('P20','20','2017-10-14','2017-10-18','Doc_15', 'W4','W4G4','Meal10') ; 
...
/*Join queries */
Select patientID,patient_Fname,patient_Lname from Patient_T where patientID in 
    (select patientID from patientregister_t where patient_RegisterID IN
    (select patient_RegisterID from patientregister_t where patient_RegisterID IN
    (select patient_RegisterID from patientdisease_t where diseaseID IN 
    (Select diseaseID as Count from patientdisease_t group by diseaseID order by Count desc))));
/* How many patients in the hospital are assigned diabetic meals? List thier names and meal description */   
...
/* Find department for Employee using joins */
